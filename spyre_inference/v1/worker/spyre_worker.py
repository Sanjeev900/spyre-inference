...
from spyre_inference import envs, register_ops
...
class TorchSpyreWorker(Worker):
    ...
    def init_device(self) -> None:
        ...
        # Register custom ops and all model architecture overrides before the model
        # is loaded. register_ops() calls register_all() (custom op kernels) and
        # register_models() (SPYRE_MODELS overrides including the Transformers backend).
        register_ops()
